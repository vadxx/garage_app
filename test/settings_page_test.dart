...
void main() {
  group('SettingsPage', () {
    ...
    testWidgets('changing language to Spanish updates provider state', (
      tester,
    ) async {
      await tester.pumpWidget(buildApp(repo));
      await tester.pumpAndSettle();
      ...
      expect(repo.load().language, backend.Language.es);
    });

    testWidgets('changing language to French updates provider state', (
      tester,
    ) async {
      await tester.pumpWidget(buildApp(repo));
      await tester.pumpAndSettle();
      ...
      expect(repo.load().language, backend.Language.fr);
    });

    testWidgets('changing language to Portuguese updates provider state', (
      tester,
    ) async {
      await tester.pumpWidget(buildApp(repo));
      await tester.pumpAndSettle();
      ...
      expect(repo.load().language, backend.Language.pt);
    });

    testWidgets('changing language to Korean updates provider state', (
      tester,
    ) async {
      await tester.pumpWidget(buildApp(repo));
      await tester.pumpAndSettle();
