          ...
          child: oilWorks.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      _oilWorkItem(context, ref, carId, oilWorks[index]),
                ),
        );
      },
...
/// Shows a bottom sheet with spending grouped by category for [carId].
void showCategoryRatingsBottomSheet(
...
/// Shows a bottom sheet with monthly spending for [carId].
void showMonthlySpendingBottomSheet(
  BuildContext context,
  WidgetRef ref,
  int carId,
) {
...
Widget _oilWorkItem(
  ...
  return ListTile(
    ...
    title: Text(work.description.isEmpty ? context.t.catOil : work.description),
