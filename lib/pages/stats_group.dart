  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget onStatsData(stats) {
      ...
      final oilHealthTile = GestureDetector(
        onTap: () => showOilHistoryBottomSheet(context, ref, carId),
        child: helpers.outlinedTile(
          context,
          _OilHealth(
            stats: stats,
      ...
      final topCatTile = _topCatTile(
        context,
        topCatValue,
        onTap: () => showCategoryRatingsBottomSheet(context, ref, carId),
      );
      final spentTile = _spentTile(
        context,
        stats,
        settings,
        onTap: () => showMonthlySpendingBottomSheet(context, ref, carId),
      );
